...
public class TCPIPAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        appTitleLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 15));
        appTitleLabel.setText("Microchip TCPIP Discoverer");

        versionLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 11));
        ...
        vendorLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 11));
        vendorLabel.setText("Vendor:");

        appVendorLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11));
        ...
        homepageLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 11));
        homepageLabel.setText("Homepage:");

        appHomepageLabel.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11));
