...
/*--------------------------------------------*/
#define WF_DEFAULT_SSID_NAME                %WF_DEFAULT_SSID_NAME%

#define WF_DEFAULT_NETWORK_TYPE             %WF_DEFAULT_NETWORK_TYPE%   /* WF_INFRASTRUCTURE or WF_ADHOC     */

#define WF_DEFAULT_SCAN_TYPE                WF_ACTIVE_SCAN      /* WF_ACTIVE_SCAN or WF_PASSIVE_SCAN */

#define WF_DEFAULT_CHANNEL_LIST             {1,6,11}            /* use {} to scan all channels       */
...
#define WF_DEFAULT_PS_POLL                   WF_ENABLED         /* WF_DISABLED or WF_ENABLED */
