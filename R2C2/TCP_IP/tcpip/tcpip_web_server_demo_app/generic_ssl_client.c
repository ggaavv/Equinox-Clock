/*******************************************************************************
  Generic TCP Client Example Application using SSL

  Summary:
    Module for Microchip TCP/IP Stack
    
  Description:
    -Implements an example HTTP client and may be used as a basis 
     for creating new TCP client applications requiring SSL support
*******************************************************************************/

/*******************************************************************************
FileName:  GenericSSLClient.c 
...
// For SSL connections, use the SSL port and a custom server for testing
static uint16_t SSLServerPort = HTTPS_PORT;
// Defines the server to be accessed for this application
static uint8_t SSLServerName[] =   "www.google.com";
// Defines the URL to be requested by this HTTP client
static const uint8_t SSLRemoteURL[] = "/search?as_q=Microchip&as_sitesearch=microchip.com";

// the server address
static IPV4_ADDR  serverIP_SSL;
...
#endif // defined(TCPIP_STACK_USE_SSL_CLIENT)
