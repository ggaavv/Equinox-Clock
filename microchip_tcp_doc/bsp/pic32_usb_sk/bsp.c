/*******************************************************************************
  PIC32 USB ESK BSP initialization file

  Summary:
    BSP Module for PIC32 USB ESK
    
  Description:
    Performs the BSP initialization of the PIC32 USB ESK board
 *******************************************************************************/
...
// PIC32 USB ESK configuration fuses
