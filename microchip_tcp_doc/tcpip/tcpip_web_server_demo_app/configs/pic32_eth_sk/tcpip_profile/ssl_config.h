...
#if SSL_MAX_CONNECTIONS > 16
	#error "SSL_MAX_CONNECTIONS may not exceed 16"
#endif

// Max number of cached SSL sessions
#define SSL_MAX_SESSIONS	(2)

#if SSL_MAX_SESSIONS > 16
	#error "SSL_MAX_SESSIONS may not exceed 16"
#endif
...
#define SSL_MAX_BUFFERS		(4ul)	

#if SSL_MAX_BUFFERS > 16
	#error "SSL_MAX_BUFFERS may not exceed 16"
#endif

// Max # of SSL hashes  (2 per, plus 1 to avoid deadlock)
#define SSL_MAX_HASHES		(5ul)
...
#define SSL_RSA_CLIENT_SIZE     (2048ul)    
