...
// This option will queue only one packet per remote neighbor.  This will
// save heap space in memory-constrained systems.
#define IPV6_QUEUE_ONLY_ONE_PACKET_PER_NEIGHBOR
