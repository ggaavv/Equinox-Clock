#if 0
// TBD: Get rid of; replaced by iperf_console.c
/*******************************************************************************
...
{
    char   buf[kWFNumHistoryEntries][kConsoleMaxMsgSize + 1];  // N lines of history
    uint8_t   index;
    bool seeded;
    int8_t   recallIndex;
} tWFHistory;
...
static const char cursorLeftEscapeSequence[]           = {kWFEscape, '[', '1', 'D', 0x00};
static const char cursorRightEscapeSequence[]          = {kWFEscape, '[', '1', 'C', 0x00};
static const char cursorHomeEscapeSequence[]           = {kWFEscape, '[', 'f', 0x00};
static const char eraseToEndOfLineEscapeSequence[]     = {kWFEscape, '[', 'K', 0x00};
static const char saveCursorPositionEscapeSequence[]   = {kWFEscape, '7', 0x00};
static const char restoreCursorPositionSequence[]      = {kWFEscape, '8', 0x00};
static const char eraseEntireLineEscapeSequence[]      = {kWFEscape, '[', '2', 'K', 0x00};
static const char eraseEntireScreenEscapeSequence[]    = {kWFEscape, '[', '2', 'J', 0x00};
static const char underlineModeEscapeSequence[]        = {kWFEscape, '[', '4', 'm', 0x00};
static const char normalModeEscapeSequence[]           = {kWFEscape, '[', 'm', 0x00};
static const char highlightModeEscapeSequence[]        = {kWFEscape, '[', '1', 'm', 0x00};
static const char inverseVideoEscapeSequence[]         = {kWFEscape, '[', '7', 'm', 0x00};
...
static const char upArrowEscapeSequence[]     = {kWFEscape, 0x5b, 'A', 0x00};
static const char downArrowEscapeSequence[]   = {kWFEscape, 0x5b, 'B', 0x00};
static const char rightArrowEscapeSequence[]  = {kWFEscape, 0x5b, 'C', 0x00};
static const char leftArrowEscapeSequence[]   = {kWFEscape, 0x5b, 'D', 0x00};
//static const char homeKeyEscapeSequence[]     = {kWFEscape, 0x5b, 'H', 0x00};
static const char homeKeyEscapeSequence[]     = {kWFEscape, 0x5b, '1', 0x00};
static const char endKeyEscapeSequence[]      = {kWFEscape, 0x5b, '4', 0x00};
...
void WFConsoleProcessEpilogue(void)
{
    if (WFConsoleIsConsoleMsgReceived())
	{
		...
		{
			WFConsolePrintStr("Unknown cmd: ", false);
			WFConsolePrintStr(ARGV[0], true);
		}
...
void Output_Monitor_Hdr(void)
{
    ...
    SYS_CONSOLE_MESSAGE("\n\r");
    SYS_CONSOLE_MESSAGE("* Command Parser\n\r");
    SYS_CONSOLE_MESSAGE("* (c) 2008, 2009, 2010 -- Microchip Technology, Inc.\n\r");
...
static void InsertCharacter(int8_t c)
{
   ...
   else
   {
      ...
      SYS_CONSOLE_MESSAGE(&g_ConsoleContext.rxBuf[0]);
...
static void Delete(void)
{
   ...
   if (GET_CURSOR() != GET_LEN_RX_CMD_STRING() + gCmdLinePromptLength)
   {
      ...
      SYS_CONSOLE_MESSAGE(g_ConsoleContext.rxBuf );
...
void WFConsolePrintInteger(uint32_t val, char mode)
{
	...
	SYS_CONSOLE_MESSAGE(g_ConsoleContext.txBuf);
}
