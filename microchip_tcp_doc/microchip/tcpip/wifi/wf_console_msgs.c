...
const int8_t getwfverCmd[]  = "getwfver";
const int8_t getwfverHelp[] = "Gets WiFi device version";
...
const int8_t ifConfigCmd[]  = "ifconfig";
const int8_t iwConfigCmd[]  = "iwconfig";
const int8_t iwPrivCmd[]    = "iwpriv";
