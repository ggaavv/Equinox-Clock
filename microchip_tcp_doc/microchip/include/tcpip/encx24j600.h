...
// Define macro for 8-bit PSP SFR address translation to SPI addresses
	...
	#error hardware_profile.h must define ENC100_TRANSLATE_TO_PIN_ADDR macro when using indirect PSP addressing
#endif
...
// ENCX24 setting definitions
#if defined (__C32__)
	#define ENC100_MAX_SPI_FREQ		(14000000ul)	// Hz
#elif defined (__C30__)
	#if defined (__PIC24F__)
		#define ENC100_MAX_SPI_FREQ		(8000000ul)	// Hz
	#else
