...
unsigned char maxBrightness = 55;//255;
unsigned char pwmFrequency = 85;//75
...
//	cli();mySerial.println("u");sei();
	...
	rgbLedRainbow(ShiftPWM.m_amountOfOutputs, 1, 1, maxBrightness/6, ShiftPWM.m_amountOfOutputs,true);
