...
public:
	...
	void SetGroupOf3Add(int group, unsigned char v0, unsigned char v1, unsigned char v2);
...
public:
	...
	unsigned char m_maxGlobalPower;
	unsigned char m_amountOfRegisters;
	unsigned char m_amountOfBits;
	unsigned char m_amountOfLEDsPerRegisters;
