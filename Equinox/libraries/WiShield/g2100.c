...
void zg_init()
{
   ...
   zg_chip_reset();
   _DBG("[OK]-zg_chip_reset()");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
   zg_interrupt2_reg();
   _DBG("[OK]-zg_interrupt2_reg()");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
   zg_interrupt_reg(0xff, 0);
   _DBG("[OK]-zg_interrupt_reg(0xff, 0)");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
   zg_interrupt_reg(0x80|0x40, 1);
   _DBG("zg_interrupt_reg(0x80|0x40, 1)");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
...
void zg_chip_reset()
{
   ...
   do {
      ...
      _DBG("[OK]-zg_chip_reset() -- 1");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
   ...
   spi_transfer(hdr, 3, 1);
   _DBG("[OK]-zg_chip_reset() -- 2");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
   ...
   _DBG("[OK]-zg_chip_reset() -- 3");_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
...
void zg_process_isr()
{
//	_DBG("E3 Interup servie routine zzzzzzzzzzzzzzzzzzzzzzz");//_DBG("LN:");_DBD(__LINE__);_DBG(" File:");_DBG_(__FILE__);
