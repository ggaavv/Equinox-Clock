...
bool        DHCPInit(const TCPIP_STACK_MODULE_CTRL* const stackCtrl,
                const DHCP_MODULE_CONFIG* pDhcpConfig);

void        DHCPDeInit(const TCPIP_STACK_MODULE_CTRL* const stackData);


void        DHCPTask(NET_CONFIG* pConfig);
