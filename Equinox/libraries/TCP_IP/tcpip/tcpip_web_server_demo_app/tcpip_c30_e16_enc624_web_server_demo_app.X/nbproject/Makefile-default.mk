...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ProjectDir="C:\mk\dev\cleanCheck\tcpip\tcpip_web_server_demo_app\tcpip_c30_e16_enc624_web_server_demo_app.X"
ConfName=default
ImagePath="dist\default\${IMAGE_TYPE}\tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\default\${IMAGE_TYPE}"
ImageName="tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"

.build-conf:  .pre ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
${OBJECTDIR}/_ext/1472/custom_ssl_cert.o: ../custom_ssl_cert.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/custom_ssl_cert.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/custom_ssl_cert.o.ok ${OBJECTDIR}/_ext/1472/custom_ssl_cert.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/custom_ssl_cert.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -DC30_EX16_ENC624 -D__LANGUAGE_C__ -I"../configs/c30_expl16/bsp_profile/enc624" -I"../configs/c30_expl16/tcpip_profile" -I".." -I"../../../microchip/include" -I"../../../microchip/tcpip" -I"../../../microchip/include/tcpip" -I"../../../microchip/tcpip/wifi" -I"../../../microchip/include/common" -mlarge-code -mlarge-data -mconst-in-data -Os -MMD -MF "${OBJECTDIR}/_ext/1472/custom_ssl_cert.o.d" -o ${OBJECTDIR}/_ext/1472/custom_ssl_cert.o ../custom_ssl_cert.c  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1,--heap=8500,--stack=500,-L"..",-Map="${DISTDIR}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1,--heap=8500,--stack=500,-L"..",-Map="${DISTDIR}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/tcpip_c30_e16_enc624_web_server_demo_app.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=elf
endif
