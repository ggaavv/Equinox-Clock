...
// by commenting out TCP_DYNAMIC_CONFIGURATION (see below)
	...
	#define TCP_SOCKET_DEFAULT_TX_SIZE		2048			

	// default socket Rx buffer size
	#define TCP_SOCKET_DEFAULT_RX_SIZE		2048			
	...
	{
		{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_DRAM, 125, 1200},
		...
		{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_DRAM, 1500, 1500},
		{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_DRAM, 1500, 1500},
		{TCP_PURPOSE_DEFAULT, TCP_PIC_DRAM, 1000, 1000},
